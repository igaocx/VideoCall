...
void x264Encode::initX264Encode(int width, int height, int fps, int bite)
{
    ...
    x264_param_default_preset(_x264_param, "ultrafast", "zerolatency");
    ...
    _x264_param->i_deblocking_filter_alphac0 = 0;
    _x264_param->i_deblocking_filter_beta = 0;
    _x264_param->analyse.b_psnr = 0; //是否使用信噪比.
    _x264_param->b_repeat_headers = 1;
    _x264_param->rc.i_rc_method = X264_RC_CRF;
    _x264_param->rc.i_bitrate = bite/1000;
    ...
    _x264_param->i_threads = X264_SYNC_LOOKAHEAD_AUTO;
	...
	_x264_param->b_deblocking_filter =0;
